<?php
session_start();
$desde_index=$_SESSION['desde_index'];
?>
<!DOCTYPE html>
        <html lang="es">
        ...
        <body>
            ...
            <header id="Cabecera">
                ...
                <div id="Salto">
                    <div id="VentanaForm">
                        <form action="../php/actualizar_contraseña.php" method="POST" class="Formulario_Registro" id="Ventana">
                        <?php 
                            if ($desde_index==true) {
                                ?>
...
<h2>RECUPERACIÓN DE CUENTA</h2>
                            ...
                            <input type="password" id="contraseña" name="nueva_contraseña" class="entrada_texto">
                            <label for="rep_contraseña">Repita la nueva contraseña:</label>
                            <input type="password" id="rep_contraseña" name="rep_nueva_contraseña" class="entrada_texto">
