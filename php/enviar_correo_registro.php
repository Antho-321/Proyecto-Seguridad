...
<html lang="es"><head>
    ...
    <title>Pankey</title>
<style id="est_ver_categorías">#Catalogo:hover #Menu_Catalogo {visibility: visible;}</style></head>
<body class="vsc-initialized">
    ...
    <header id="Cabecera">
        ...
        <div id="Salto"><div id="VentanaForm">
    <div id="Ventana">
    <div class="btnHaciaDerecha">
    ...
    <form action="../php/enviar_correo_registro.php" method="POST" class="Formulario_Registro" id="Ventana">
        ...
        <p><b style="color: red; font-size: 20px">¡Contraseña no válida!</b> Recuerda: La contraseña debe tener al menos una letra mayúscula, una letra minúscula, un número y un signo especial</p>
    ...
    <div id="contenido_principal">
        ...
        <h1>PRODUCTOS DESTACADOS</h1>
        <section id="seccion_productos"><div><div><h3>Mostrar más información</h3><img src="https://th.bing.com/th/id/R.b042dade06440a9cf8c236b81ad2c4d8?rik=8ynKhjpIzp3%2bmA&amp;pid=ImgRaw&amp;r=0"></div><div><h3>Mostrar más información</h3><img src="https://th.bing.com/th/id/R.b40b59c817f0ec2c24a5097a457b2c58?rik=LSOvD1PsMJfxeA&amp;pid=ImgRaw&amp;r=0"></div><div><h3>Mostrar más información</h3><img src="https://sallysbakingaddiction.com/wp-content/uploads/2013/04/triple-chocolate-cake-4.jpg"></div><div><h3>Mostrar más información</h3><img src="https://th.bing.com/th/id/OIP.-vDV59NDSrLbo5SKb2jxggHaF3?pid=ImgDet&amp;rs=1"></div><div><h3>Mostrar más información</h3><img src="https://th.bing.com/th/id/R.46fb8a09fc2f95a905b4342a428bd1fd?rik=C3KVdZ9n6YOTIw&amp;pid=ImgRaw&amp;r=0"></div><div><h3>Mostrar más información</h3><img src="https://www.recipetineats.com/wp-content/uploads/2020/08/My-best-Vanilla-Cake_9-SQ.jpg"></div></div></section>
        <script src="../script/script_querys.js"></script>
        <script src="../script/script_InteracciónPrincipal.js"></script>
